...
//        Optional<Integer> optInt = optStr.map(s -> s.length();
        ...
        Optional.of("456").map(Integer::parseInt)
                .ifPresent(x->System.out.printf("result3=%d%n",x)); //ifPresent null아닐때만 실행
        ...
        System.out.println(optInt1.getAsInt());   // 0 ifPresent -- true
//		System.out.println(optInt2.getAsInt());   // NoSuchElementException  ifPresent -- false
